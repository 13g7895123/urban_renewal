import { defineComponent, inject, computed, unref, defineAsyncComponent, shallowRef, h, Suspense, nextTick, mergeProps, provide, shallowReactive, createVNode, resolveDynamicComponent, withCtx, createBlock, createCommentVNode, openBlock, renderSlot, toRef, ref, toDisplayString, useAttrs, toValue, getCurrentInstance, useSSRContext } from 'vue';
import { _ as _export_sfc, u as useNuxtApp, P as PageRouteSymbol, a as useRoute, b as appLayoutTransition, c as _wrapInTransition, L as LayoutMetaSymbol, t as twMerge, m as mergeConfig, e as appConfig, d as useAppConfig, g as get, o as omit, l as looseToNumber, f as __nuxt_component_0$2$1 } from './server.mjs';
...
import __nuxt_component_1$2 from './index-BRDSpBS1.mjs';
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-CiKeu3b4.mjs').then((m) => m.default || m))
};
...
export { __nuxt_component_0$2 as _, __nuxt_component_1$1 as a, __nuxt_component_4 as b, __nuxt_component_0 as c };
//# sourceMappingURL=Button-CUPZ9vdw.mjs.map
