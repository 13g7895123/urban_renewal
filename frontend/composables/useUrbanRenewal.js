...
export const useUrbanRenewal = () => {
  ...
  const getUrbanRenewals = async (params = {}) => {
    return await get('/urban-renewals', params)
  }
  ...
  const getUrbanRenewal = async (id) => {
    return await get(`/urban-renewals/${id}`)
  }
  ...
  const createUrbanRenewal = async (data) => {
    return await post('/urban-renewals', data)
  }
  ...
  const updateUrbanRenewal = async (id, data) => {
    return await put(`/urban-renewals/${id}`, data)
  }
  ...
  const deleteUrbanRenewal = async (id) => {
    return await del(`/urban-renewals/${id}`)
  }
  ...
  const getLandPlots = async (renewalId, params = {}) => {
    return await get(`/urban-renewals/${renewalId}/land-plots`, params)
  }
  ...
  const createLandPlot = async (renewalId, data) => {
    return await post(`/urban-renewals/${renewalId}/land-plots`, data)
  }
  ...
  const getPropertyOwners = async (renewalId, params = {}) => {
    return await get(`/urban-renewals/${renewalId}/property-owners`, params)
  }
