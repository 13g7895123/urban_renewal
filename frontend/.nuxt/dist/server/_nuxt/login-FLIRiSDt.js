import { _ as __nuxt_component_0, a as __nuxt_component_1, b as __nuxt_component_4, c as __nuxt_component_0$1 } from "./Button-CUPZ9vdw.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "auth" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-center py-12" data-v-77fd791f${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UCard, { class: "login-card w-full max-w-md" }, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center" data-v-77fd791f${_scopeId2}><h2 class="text-2xl font-bold text-gray-800" data-v-77fd791f${_scopeId2}>登入</h2></div>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<form class="space-y-6" data-v-77fd791f${_scopeId2}><div class="input-group" data-v-77fd791f${_scopeId2}>`);
                  ...
                  _push3(`</div><div class="input-group" data-v-77fd791f${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_Icon, {
...
const login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-77fd791f"]]);
export {
  login as default
};
//# sourceMappingURL=login-FLIRiSDt.js.map
