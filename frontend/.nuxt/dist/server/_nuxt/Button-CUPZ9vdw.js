import { defineAsyncComponent, defineComponent, inject, computed, unref, shallowRef, h, Suspense, nextTick, mergeProps, provide, shallowReactive, useAttrs, toValue, createVNode, resolveDynamicComponent, withCtx, createBlock, createCommentVNode, openBlock, renderSlot, toRef, useSSRContext, ref, getCurrentInstance, toDisplayString } from "vue";
import { u as useNuxtApp, P as PageRouteSymbol, a as useRoute, b as appLayoutTransition, c as _wrapInTransition, L as LayoutMetaSymbol, d as useAppConfig, m as mergeConfig, g as get, o as omit, _ as _export_sfc, t as twMerge, e as appConfig, l as looseToNumber, f as __nuxt_component_0$3 } from "../server.mjs";
...
import __nuxt_component_1$2 from "./index-BRDSpBS1.js";
const nuxtLinkProps = {
  to: {
    type: [String, Object],
    default: void 0,
...
const layouts = {
  auth: defineAsyncComponent(() => import("./auth-CiKeu3b4.js").then((m) => m.default || m))
};
...
//# sourceMappingURL=Button-CUPZ9vdw.js.map
