import { _ as __nuxt_component_0, a as __nuxt_component_1, c as __nuxt_component_0$1, b as __nuxt_component_4 } from "./Button-CUPZ9vdw.js";
import __nuxt_component_1$1 from "./index-BRDSpBS1.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        "logo-style": `max-height: 80px; width: auto;`
      }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-start justify-center pt-16 pb-8 w-full" data-v-dc46edac${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="progress-container mb-8" data-v-dc46edac${_scopeId2}><div class="flex justify-between items-center" data-v-dc46edac${_scopeId2}><div class="${ssrRenderClass([{ active: unref(currentStep) === 1, completed: unref(currentStep) > 1 }, "step-item"])}" data-v-dc46edac${_scopeId2}><div class="step-circle" data-v-dc46edac${_scopeId2}>`);
                  if (unref(currentStep) > 1) {
                    ...
                    _push3(`<span data-v-dc46edac${_scopeId2}>1</span>`);
                  }
                  _push3(`</div><div class="step-text" data-v-dc46edac${_scopeId2}>選擇帳號類型</div></div><div class="${ssrRenderClass([{ completed: unref(currentStep) > 1 }, "step-line"])}" data-v-dc46edac${_scopeId2}></div><div class="${ssrRenderClass([{ active: unref(currentStep) === 2, completed: unref(currentStep) > 2 }, "step-item"])}" data-v-dc46edac${_scopeId2}><div class="step-circle" data-v-dc46edac${_scopeId2}>`);
                  if (unref(currentStep) > 2) {
                    ...
                    _push3(`<span data-v-dc46edac${_scopeId2}>2</span>`);
                  }
                  _push3(`</div><div class="step-text" data-v-dc46edac${_scopeId2}>填入資料</div></div><div class="${ssrRenderClass([{ completed: unref(currentStep) > 2 }, "step-line"])}" data-v-dc46edac${_scopeId2}></div><div class="${ssrRenderClass([{ active: unref(currentStep) === 3, completed: unref(currentStep) > 3 }, "step-item"])}" data-v-dc46edac${_scopeId2}><div class="step-circle" data-v-dc46edac${_scopeId2}>`);
                  if (unref(currentStep) > 3) {
                    ...
                    _push3(`<span data-v-dc46edac${_scopeId2}>3</span>`);
                  }
                  _push3(`</div><div class="step-text" data-v-dc46edac${_scopeId2}>完成</div></div></div></div>`);
                  if (unref(currentStep) === 1) {
                    _push3(`<div class="account-selection" data-v-dc46edac${_scopeId2}><div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8" data-v-dc46edac${_scopeId2}><div class="${ssrRenderClass([{ "selected": unref(selectedAccountType) === "personal" }, "account-option"])}" data-v-dc46edac${_scopeId2}><button class="${ssrRenderClass([{ "active": unref(selectedAccountType) === "personal" }, "account-btn personal-btn w-full"])}" data-v-dc46edac${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_Icon, {
                      name: "heroicons:user",
                      class: "w-8 h-8 mb-2"
                    }, null, _parent3, _scopeId2));
                    _push3(`<div class="text-lg font-semibold" data-v-dc46edac${_scopeId2}>個人帳號</div></button><div class="radio-container" data-v-dc46edac${_scopeId2}><label class="radio-label" data-v-dc46edac${_scopeId2}><input type="radio" name="accountType" value="personal"${ssrIncludeBooleanAttr(unref(selectedAccountType) === "personal") ? " checked" : ""} class="radio-btn" data-v-dc46edac${_scopeId2}></label></div></div><div class="${ssrRenderClass([{ "selected": unref(selectedAccountType) === "business" }, "account-option"])}" data-v-dc46edac${_scopeId2}><button class="${ssrRenderClass([{ "active": unref(selectedAccountType) === "business" }, "account-btn business-btn w-full"])}" data-v-dc46edac${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_Icon, {
                      name: "heroicons:building-office",
                      class: "w-8 h-8 mb-2"
                    }, null, _parent3, _scopeId2));
                    _push3(`<div class="text-lg font-semibold" data-v-dc46edac${_scopeId2}>企業帳號</div></button><div class="radio-container" data-v-dc46edac${_scopeId2}><label class="radio-label" data-v-dc46edac${_scopeId2}><input type="radio" name="accountType" value="business"${ssrIncludeBooleanAttr(unref(selectedAccountType) === "business") ? " checked" : ""} class="radio-btn" data-v-dc46edac${_scopeId2}></label></div></div></div>`);
                  ...
                  if (unref(currentStep) === 2) {
                    _push3(`<div class="form-section" data-v-dc46edac${_scopeId2}>`);
                    if (unref(selectedAccountType) === "personal") {
                      _push3(`<div class="form-grid" data-v-dc46edac${_scopeId2}><div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6" data-v-dc46edac${_scopeId2}><div class="form-field" data-v-dc46edac${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_UInput, {
                        modelValue: unref(formData).account,
                        "onUpdate:modelValue": ($event) => unref(formData).account = $event,
                        placeholder: "帳號"
                      }, null, _parent3, _scopeId2));
                      _push3(`</div><div class="form-field" data-v-dc46edac${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_UInput, {
                    ...
                    _push3(`<div class="flex gap-4 mt-4" data-v-dc46edac${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_UButton, {
                  ...
                  if (unref(currentStep) === 3) {
                    _push3(`<div class="completion-section text-center" data-v-dc46edac${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_Icon, {
                      name: "heroicons:check-circle",
                      class: "w-16 h-16 text-green-500 mx-auto mb-4"
                    }, null, _parent3, _scopeId2));
                    _push3(`<h3 class="text-2xl font-bold mb-4" data-v-dc46edac${_scopeId2}>註冊完成！</h3><p class="text-gray-600 mb-6" data-v-dc46edac${_scopeId2}>您的帳號已成功建立</p>`);
                    _push3(ssrRenderComponent(_component_UButton, {
                  ...
                  return [
                    ...
                    unref(currentStep) === 3 ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("h3", { class: "text-2xl font-bold mb-4" }, "註冊完成！"),
...
const signup = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc46edac"]]);
export {
  signup as default
};
//# sourceMappingURL=signup-B17IxsxH.js.map
