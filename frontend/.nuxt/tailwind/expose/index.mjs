...
const config = { theme, corePlugins, plugins, content, safelist, darkMode, presets, prefix, important, separator, blocklist, variants }
export { config as default, theme, corePlugins, plugins, content, safelist, darkMode, presets, prefix, important, separator, blocklist, variants }